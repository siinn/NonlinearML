...
output_path = '/mnt/mainblob/earnings-transcripts-sp/data_meta_feature/return_meta_feature_R1000_ALL_v5.p1.csv'
...
if __name__ == "__main__":
    ...
    if run_eda:
        ...
        plot_distribution(
            ...
            x_label=[], y_label=["Samples"]*n_plots, figsize=(18,6),
        ...
        plot_null(
            df, features+labels, figsize=(15,8), filename=plot_path+"null_fraction")
    
        # plot fraction of null values as a function of time
        n_rows=1
        n_columns=3
        plot_null_vs_time(
            df, time=time, columns=features+labels,
            n_rows=n_rows, n_columns=n_columns,
            figsize=(16,8), filename=plot_path+"null_fraction_time", ylim=(0,0.01))
