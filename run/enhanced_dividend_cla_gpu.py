...
# Set labels
n_classes=10
class_label={x:'D'+str(x) for x in range(10)}
class_order = [9, 8, 7, 6, 5, 4, 3, 2, 1, 0] # High return to low return
...
if __name__ == "__main__":
    ...
    # Shift label by 1 so that it starts from 0.
    df['QntfqRet'] = df['QntfqRet'].transform(lambda x:x-1)
